...
const phones: Record<MobilePhoneLocale | string, RegExp> = {
...
/**
 * A helper function check whether the input string is a valid phone number for a country
 * @example 
 *  if (isMobilePhone(input, "en-GH")) {
 *       break;
 *  }
 * @see {@link https://github.com/validatorjs/validator.js/blob/master/src/lib/isMobilePhone.js#L43 }
 * @param str string
 * @param locale string
...
export const isMobilePhoneLocales = Object.keys(phones) as MobilePhoneLocale[];